...
const std::string yara_get_something_for_register_global_function_34 = "40 55 53 57 48 8D AC 24 60 FF FF FF 48 81 EC A0 01 00 00 BA 10 00 00 00 B9 C0 00 00 00 44 8D 42 07 E8 ?? ?? ?? ??";
